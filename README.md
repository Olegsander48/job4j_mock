...
### Запуск проекта.
1. Установить на вашу машину docker и docker-compose
2. Перейти в папку с проектом
3. Выполнить команду по сборке проекта
```
docker-compose build
```
4. После успешной сборки проекта выполнить команду
```
docker-compose up
```
5. Перейти в браузер по адресу http://localhost:8080/ и наслаждаться проектом:)
___
